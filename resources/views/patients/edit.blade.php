...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('patients.show', $patient->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Patient Information</h6>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('patients.update', $patient->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('medical_history') is-invalid @enderror" 
                                  ...
                                  placeholder="Any pre-existing conditions, allergies, medications, etc.">{{ old('medical_history', $patient->medical_history) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('patients.show', $patient->id) }}" class="btn btn-secondary btn-lg">
